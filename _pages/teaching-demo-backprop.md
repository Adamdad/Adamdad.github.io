...
demo_badge: "Demo 6 · Training a network with backpropagation"
...
**What to look for:** watch the hidden-layer columns `H¹` and `H²` — early on they mix the two classes together, but after enough update steps they separate cleanly into red and blue columns. That separation is the network *discovering* a feature map like the one Demo 4 hands over by hand.
